...
10/08/2019 - Slightly changed the Shape class interface. The constructor order is different and it now takes an extra 'uv_indices' argument. See pyredner/shape.py.  
