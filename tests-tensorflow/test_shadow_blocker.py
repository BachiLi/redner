...
floor_indices = tfe.Variable([[0,1,2], [1,3,2]],
    dtype=tf.int32)
...
blocker_indices = tfe.Variable([[0,1,2], [1,3,2]],
    dtype=tf.int32)
...
light_indices = tfe.Variable([[0,2,1], [1,2,3]],
    dtype=tf.int32)
...
pyredner.imwrite(tf.abs(target - img).cpu(), 'results/test_shadow_blocker/final_diff.png')
