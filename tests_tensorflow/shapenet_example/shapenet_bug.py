...
materials = [pyredner.Material(diffuse_reflectance = tf.constant([1,1,1.]),
                               specular_reflectance = tf.constant([0,0,0.]),
                               roughness = tf.constant([0.5]),
                               two_sided = True)]
